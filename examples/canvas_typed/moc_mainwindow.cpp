...
void CanvasView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (CanvasView::*)(QtCanvasItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanvasView::itemClicked)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CanvasView::*)(QtCanvasItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CanvasView::itemMoved)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CanvasView::staticMetaObject = { {
    QMetaObject::SuperData::link<QtCanvasView::staticMetaObject>(),
